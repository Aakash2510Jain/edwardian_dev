({
    ...
    saveRecords : function(component,event){
        ...
        var fieldsList=['Hotel Name','Tour Code','Date From','Date To','Rooms','Room Type','Is Breakfast Included?','Overwrite Standard Price','Double/Twin Single Occupancy','Double/Twin Double Occupancy','Triple Room 2 Adults + 1 Child(0-12 yrs)','Triple Room 3 Adults'];
        ...
        action.setParams({ fileData : component.get("v.fileContentData"),
                          sobjectName:'Group_Series_Rates__c', //Any object
                          fields:fieldsList,
                          recordId:recId});
